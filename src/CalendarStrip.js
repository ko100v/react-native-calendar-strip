...
class CalendarStrip extends Component {
  ...
  onDateSelected = (selectedDate, completeLifecycle = true, autoUpdateWeekView) => {
    let newState;
    if (this.props.scrollable) {
    ...
    this.setState(newState, () => {
      if (autoUpdateWeekView) {
        this.updateWeekView(this.state.selectedDate)
      }
    });
  ...
  setSelectedDate = (date, completeLifecycle, autoUpdateWeekView) => {
    let mDate = moment(date);
    this.onDateSelected(mDate, completeLifecycle, autoUpdateWeekView);
  }
